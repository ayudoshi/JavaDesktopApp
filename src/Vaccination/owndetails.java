...
class owndetails implements ActionListener{
    JFrame f;
    JLabel id8,id,aid,id1,aid1,id2,aid2,id4,aid4,id5,aid5,id6,aid6,id9;
    String emp_id,name,father,phone,email,dob,aadhar;
    JButton b1,b2;
    int  count;

    owndetails(String e_id){
        try{
            conn con = new conn();
            conn c = new conn();
            String str = "select * from data where id = '"+login.com1+"'";
            ...
            String q="select count(*) from data where username='ayush'";
        ...
        id6= new JLabel("Total Members added:");
        id6.setBounds(50,320,100,30);
        id6.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id6);

        aid6= new JLabel(String.valueOf(count));
